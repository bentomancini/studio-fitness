                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {linkWhats && (
                      <a
                        ...
                        className="flex h-8 items-center gap-1.5 rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-2.5 text-xs font-semibold text-emerald-400 transition-colors hover:bg-emerald-500/20"
                      >
                        <svg
                          viewBox="0 0 24 24"
                          fill="currentColor"
