                  ...
                  <div className="flex flex-wrap items-center gap-1.5">
                    ...
                    {linkWhats && (
                      <a
                        ...
                        className="btn-press flex h-8 items-center gap-1.5 rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-2 text-xs font-semibold text-emerald-400 transition-colors hover:bg-emerald-500/20"
                      >
                        <svg
                          viewBox="0 0 24 24"
                          fill="currentColor"
                    ...
                    <Link
                      href={`/alunos/${aluno.id}`}
                      className="btn-press flex h-8 items-center gap-1 rounded-xl border border-white/10 bg-zinc-900/80 px-2.5 text-xs font-medium text-zinc-300 transition-colors hover:bg-zinc-800 hover:text-white"
                    >
                    ...
                    <Link
                      ...
                      className="btn-press flex h-8 w-8 items-center justify-center rounded-xl border border-white/10 bg-zinc-900/80 text-xs font-medium text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-white"
                      title="Editar ficha"
